...
import br.com.caelum.estoque.soap.AutorizationException;
...
//	public void verificaDisponibilidadeDosItensComRmi() throws RemoteException, MalformedURLException, NotBoundException {
//		EstoqueRmi estoque = (EstoqueRmi) Naming.lookup("rmi://localhost:1099/estoque");
//		
//		for (ItemCompra itemCompra : itensDeCompra) {
//			if (itemCompra.isImpresso()) {
//				System.out.println("Verificacao da qtde do livro: " + itemCompra.getTitulo());
...
//	}
	...
	public void verificaDisponibilidadeDosItensComSoap() throws AutorizationException {
		...
		for (ItemEstoque itemEstoque : itensNoEstoque) {
